...
namespace Mkey
{
    public class ChestBehavior : MonoBehaviour
    {
        ...
        [SerializeField]
        private string coinsFormat = "0,0"; // https://docs.microsoft.com/en-us/dotnet/standard/base-types/standard-numeric-format-strings

        #region properties
        public int Coins { get; set; }
        public CoinProcAnim CoinsFountain { get; set; }
        ...
        public void Open(Action completeCallBack)
        {
          ...
          .AddCompleteCallBack(callBack);
            ...
            ts.Add((callBack) =>
            {
                ...
                if (coinsText)
                {
                    coinsText.text = Coins.ToString(coinsFormat);
